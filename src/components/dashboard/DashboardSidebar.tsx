import { BarChart3, TrendingUp, ShoppingCart, Filter, Share2, Package, Gauge, Zap, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between p-4 border-b border-sidebar-border">
        {!collapsed && (
          <div>
            <div className="text-xl font-bold text-primary tracking-tight">CIMED</div>
            <div className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground mt-0.5">Growth Platform</div>
          </div>
        )}
        <button
          onClick={() => setCollapsed(!collapsed)}
          className="p-1.5 rounded-md hover:bg-sidebar-accent transition-colors text-secondary-foreground"
        >
